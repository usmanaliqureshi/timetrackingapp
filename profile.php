...
if ($timeApp->is_logged_in()) {
    ...
    <head>
        ...
        <title>Time Tracking App v<?php echo APP_VERSION; ?> - Profile Settings</title>
                        ...
                        <div class="box box-primary">
                            <div class="box-body box-profile">
                                <img class="profile-user-img img-responsive img-circle"
                                     src="<?php echo $profile_img; ?>" alt="User profile picture">
                        ...
                        <span class="username">
                          ...
                          <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
                                        ...
                                        <div class="row margin-bottom">
                                            <div class="col-sm-6">
                                                <img class="img-responsive" src="assets/dist/img/photo1.png"
                                                     alt="Photo">
                                            </div>
                                            <!-- /.col -->
                                            <div class="col-sm-6">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <img class="img-responsive" src="assets/dist/img/photo2.png"
                                                             alt="Photo">
                                                        <br>
                                                        <img class="img-responsive" src="assets/dist/img/photo3.jpg"
                                                             alt="Photo">
                                                    </div>
                                                    <!-- /.col -->
                                                    <div class="col-sm-6">
                                                        <img class="img-responsive" src="assets/dist/img/photo4.jpg"
                                                             alt="Photo">
                                                        <br>
                                                        <img class="img-responsive" src="assets/dist/img/photo1.png"
                                                             alt="Photo">
